...
public class OrderGUI extends JFrame {
	...
	public OrderGUI()
	{
        ...
        // Create labels
		JLabel codeLabel = new JLabel("Number");
		JLabel titleLabel = new JLabel("Date");
        JLabel descriptionLabel = new JLabel("Customer");
        JLabel locationLabel = new JLabel("Item");
        JLabel dailyPriceLabel = new JLabel("Price");
